    ...
    <div class="col-lg-8 offset-lg-2">
        ...
        <div class="card">
            <div class="card-header">
                <h5>Nouveau Type Média </h5>
            </div>

            <form method="POST" action="{{ route('admin.typemedias.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-primary btn-block">Ajouter Type Média</button>
                </div>
