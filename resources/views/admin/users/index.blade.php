            ...
            <div class="card-body">
                <div class="row align-items-center m-l-0">
                    ...
                    <div class="col-sm-6 text-end">
                        <a href="{{ route('super.users.create') }}" class="btn btn-primary btn-sm mb-3 btn-round" data-toggle="" data-target=""> <i class="fa fa-plus"></i>
                            Ajouter utilisateur
                        </a>
                    </div>
                </div>
                    ...
                    <table id="simpletable" class="table table-striped table-bordered nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('super.users.edit', $user->id) }}" class="btn btn-primary btn-sm">Editer</a>
